    ...
    (function (htmlui) {
        var listBox = (function () {
            function listBox(parent) {
                ...
                this.txtArea["inv"] = this; //将自己的引用挂上去，需要的时候可以用dom元素反过来查
    ...
    (function (htmlui) {
        ...
        var guiframework = (function () {
            function guiframework(div) {
                this.listLine = [];
                this.indexLine = 0;
                //private indexCol: number = -1;
                //private flowh: boolean = false;
                this.container = [];
                this.mapItemInfo = {};
                this.resetall = false;
            ...
            guiframework.prototype.remove = function (e) {
                if (e.parentNode != null)
                    e.parentNode.removeChild(e);
                //var c = (e["container"] as iContainer);
                //if (c != null)
                //{
                //    c.end();
                //}
            ...
            guiframework.prototype.add = function (cachename, domctor, cssname, cssext) {
                ...
                //    }
                //    div.appendChild(document.createElement(domname));
                //    e = div;
                //}
                //else {
                //    e = document.createElement(domname);
                //}
                //this.addDom(e, cachename, cssname, cssext);
                return e;
            };
        ...
        var gui = (function (_super) {
            ...
            gui.prototype.add_ButtonImg = function (text, imgurl, cssname, cssext) {
                var _this = this;
                if (cssname === void 0) { cssname = ""; }
                if (cssext === void 0) { cssext = null; }
                var btn_ctor = function () {
...
(function (lighttool) {
    ...
    (function (htmlui) {
        ...
        })(htmlui.direction || (htmlui.direction = {}));
        var direction = htmlui.direction;
        var panel = (function () {
            function panel(div) {
                this.divRoot = null;
                this.subPanels = null;
        ...
        var panelMgr = (function () {
            function panelMgr() {
                ...
                this.divRoot = null;
                this.root = null; //面板层
                this.floatDiv = null; //漂浮层
                this.overDiv = null; //覆盖层
                this.overDiv_Show = null; //覆盖层
...
//# sourceMappingURL=lt_htmlui.js.map