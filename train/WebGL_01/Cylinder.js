var APP = (function () {
    ...
    APP.prototype.creat_shader = function (id) {
        var shader;
    ...
    APP.prototype.creat_program = function (vs, fs) {
    ...
    APP.prototype.creat_vbo = function (data) {
    ...
    APP.prototype.creat_ibo = function (data) {
    ...
    APP.prototype.make_vbo = function (prg, key, value, attrilen) {
...
var Cylinder = (function () {
    function Cylinder(gl, canv, _n, _r, _h) {
        this.rept = 3;
        this.inddata = new Array();
        this.count = 0;
        this.gll = gl;
        this.cleraGL();
        this.canv = canv;
    ...
    Cylinder.prototype.creat_verdata = function () {
    ...
    Cylinder.prototype.creat_nordata = function () {
        var nordata = new Array();
        var norcount = 0;
    ...
    Cylinder.prototype.creat_indxdata = function () {
    ...
    Cylinder.prototype.creat_uvdata = function () {
    ...
    Cylinder.prototype.initShader = function () {
    ...
    Cylinder.prototype.initdata = function () {
    ...
    Cylinder.prototype.initImg = function (img) {
        //绑定图片
    ...
    Cylinder.prototype.cleraGL = function () {
    ...
    Cylinder.prototype.drawself = function () {
        var _this = this;
        var m = new matIV();
        ...
        var draw = function () {
            _this.cleraGL();
            _this.count++;
            _this.gll.uniform1i(uniLocation[3], 0);
            var ang = (_this.count % 360) * Math.PI / 180;
            m.identity(mMat);
            m.rotate(mMat, ang, [1, 0, 0], mMat);
            m.multiply(tMat, mMat, mvpMat);
            m.inverse(mMat, invMatrix);
            _this.gll.uniformMatrix4fv(uniLocation[0], false, mvpMat);
            _this.gll.uniformMatrix4fv(uniLocation[1], false, invMatrix);
            _this.gll.uniform3fv(uniLocation[2], lightDirection);
            _this.gll.uniform4fv(uniLocation[4], ambientColor);
            _this.gll.drawElements(_this.gll.TRIANGLES, _this.inddata.length, _this.gll.UNSIGNED_SHORT, 0);
            requestAnimationFrame(draw);
            _this.gll.flush();
        };
        draw();
    };
    Cylinder.prototype.getcurfiles = function (imgname, imgsrc, objname, mtlname) {
        ...
        var strs = this.toobj(mtlname);
        FileHelper.SaveStringFile(objname, strs[0]);
        FileHelper.SaveStringFile(mtlname, this.tomtl(strs[1]));
        //}
    };
